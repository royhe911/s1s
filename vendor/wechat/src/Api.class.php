...
namespace Jhtx\WechatSdk;

use Jhtx\WechatSdk\Utils\HttpCurl;
use Jhtx\WechatSdk\Utils\Error;
use Jhtx\WechatSdk\Utils\SHA1;
use Jhtx\WechatSdk\Utils\Xml;
...
class Api 
{
     ...
     * ```
     */
    public function get_jsapi_config($jsapi_ticket='',$url = '', $type = '', $jsonp_callback = 'callback')
    {
     ...
     * @return string
     */
    public function get_authorize_url_pc($scope, $redirect_uri, $state = '')
    {
        $redirect_uri = urlencode($redirect_uri);
//         $url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=' . $this->appId .
//             '&redirect_uri=' . $redirect_uri . '&response_type=code&scope=' . $scope .
//             '&state=' . $state . '#wechat_redirect';
        ...
        $url =" https://open.weixin.qq.com/connect/qrconnect?appid={$this->appId}&redirect_uri={$redirect_uri}&response_type=code&scope=snsapi_login&state=123456790#wechat_redirect";
        return $url;
    }

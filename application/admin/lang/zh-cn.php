...
return [
    ...
    'Are you sure you want to enable the %s selected item?' => '确定启用选中的 %s 项?',
    'Are you sure you want to disable the %s selected item?'=> '确定禁用选中的 %s 项?',
